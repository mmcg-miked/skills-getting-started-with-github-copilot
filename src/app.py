...
activities = {
    ...
    "Tennis Club": {
        "description": "Learn tennis techniques and play tournaments",
    ...
    "Drama Club": {
        "description": "Perform in stage productions and theatrical performances",
...
def remove_participant(activity_name: str, email: str):
    ...
    # Ensure the student is signed up
